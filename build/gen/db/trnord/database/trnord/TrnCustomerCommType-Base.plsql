-----------------------------------------------------------------------------
--
--  Logical unit: TrnCustomerCommType
--  Component:    TRNORD
--
--  Template:     3.0
...
DB_PHONE                       CONSTANT VARCHAR2(5) := 'PHONE';
DB_FAX                         CONSTANT VARCHAR2(3) := 'FAX';
DB_EMAIL                       CONSTANT VARCHAR2(5) := 'EMAIL';
DB_POSTAL                      CONSTANT VARCHAR2(6) := 'POSTAL';
