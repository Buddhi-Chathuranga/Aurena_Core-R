...
PROCEDURE Remove___ (
   remrec_         IN OUT trn_customer_invoice_tab%ROWTYPE,
   lock_mode_wait_ IN     BOOLEAN DEFAULT TRUE )
IS
   oldrec_     trn_customer_invoice_tab%ROWTYPE;
BEGIN
...
-- Paid_In_Full___
--    Evaluates the PaidInFull condition within the finite state machine.
...
PROCEDURE Finite_State_Set___ (
   rec_   IN OUT trn_customer_invoice_tab%ROWTYPE,
   state_ IN     VARCHAR2 )
IS
BEGIN
