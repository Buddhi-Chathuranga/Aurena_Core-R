...
DB_EXPRESS                     CONSTANT VARCHAR2(7) := 'EXPRESS';
DB_MAIL                        CONSTANT VARCHAR2(4) := 'MAIL';
DB_OTHER                       CONSTANT VARCHAR2(5) := 'OTHER';
